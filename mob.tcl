...
set namfile [open mob.nam w]

#Tracing all the events and cofiguration
$ns namtrace-all-wireless $namfile $val(x) $val(y)

#Trace File creation
set tracefile [open mob.tr w]
...
$ns at 1.0 "$node0 setdest 2.0 2.0 5.0"
$ns at 1.0 "$node5 setdest 4.0 4.0 5.0"
$ns at 1.0 "$node7 setdest 6.0 6.0 5.0"
# Label and coloring
