...
$ns duplex-link $n(1) $n(2) 0.5Mb 50ms DropTail 
$ns duplex-link $n(1) $n(3) 0.5Mb 50ms DropTail
$ns duplex-link $n(1) $n(4) 0.5Mb 50ms DropTail
$ns duplex-link $n(2) $n(5) 0.5Mb 50ms DropTail
$ns duplex-link $n(2) $n(3) 0.5Mb 50ms DropTail
...
$ns at 0.3 "$n(3) join-group $rcvr $group"
$ns at 0.6 "$n(4) join-group $rcvr $group"
$ns at 0.9 "$n(5) join-group $rcvr $group"
$ns at 1.2 "$n(4) leave-group $rcvr $group"
$ns at 1.5 "$n(3) leave-group $rcvr $group"

$ns at 0.4 "$src1 start"
$ns at 1.0 "$src2 start"
